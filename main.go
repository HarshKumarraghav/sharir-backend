...
func main() {
	...
	// `db := client.Database("sharir")` is creating a new database instance named "sharir" using the
	// MongoDB client connection. This allows the application to interact with the "sharir" database using
